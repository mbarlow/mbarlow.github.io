...
import {
  VoxelAnimationManager,
  VoxelAnimationPresets,
} from "../utils/VoxelAnimations.js";
...
export class VoxelIndicatorComponent extends Component {
  ...
  getVoxelIndex(x, y, z) {
    return (
      z * (this.gridSize.width * this.gridSize.height) +
      y * this.gridSize.width +
      x
    );
  }
          ...
          case "appear":
            if (now >= this.stateChangeTime + voxel.appearDelay) {
              ...
              const animationStartTime =
                this.stateChangeTime + voxel.appearDelay;
